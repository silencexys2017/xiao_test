...
K_DB_URL = {
    "dev": "mongodb://root:NX9NfRBkth@127.0.0.1/admin",
...
if __name__ == "__main__":
    ...
    common_db = get_db(K_DB_URL, "dev", "Common")
    bee_common_db = get_db(X_DB_URL, "test", "BeeCommon")
    member_db = get_db(K_DB_URL, "dev", "Member")
