...
place_order_api = " http://8.214.27.92:8480/open-api/express/order/createOrder"
print_order_api = " http://8.214.27.92:8480/open-api/express/order/print"
query_track_api = " http://8.214.27.92:8480/open-api/express/track/query"
cancel_order_api = " http://8.214.27.92:8480/open-api/express/order/cancelOrder"
subscribe_track_api = " http://8.214.27.92:8480/open-api/express/track/subscribe"
get_areas_api = " http://8.214.27.92:8480/open-api/common/area/getArea"
get_area_tree_api = " http://8.214.27.92:8480/open-api/common/area/getAreaTree"
# get_area_tree_api = "https://apis.speedaf.com/open-api/common/area/getAreaTree"

notify_url = "https://openapi-test.xedelivery.cn/express/speedaf/track/callback"
place_order_url = ""
inquiry_url = ""
...
if __name__ == "__main__":
    ...
    # res = get_area_tree(country_code="NG")
