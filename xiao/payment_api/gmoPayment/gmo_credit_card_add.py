...
PRE_CREATE_URL = "https://p01.mul-pay.jp/payment/EntryTran.json"
EXECUTE_URL = "https://p01.mul-pay.jp/payment/ExecTran.json"
DS1_AUTH_URL = "https://p01.mul-pay.jp/payment/SecureTran.json"
DS2_AUTH_URL = "https://p01.mul-pay.jp/payment/SecureTran2.json"
UPDATE_PAY_URL = "https://p01.mul-pay.jp/payment/AlterTran.json"
UPDATE_AMOUNT_URL = "https://p01.mul-pay.jp/payment/ChangeTran.json"
QUERY_STATUS_URL = "https://p01.mul-pay.jp/payment/SearchTrade.json"
...
def encrypt_with_rsa(key, plain_text):
    ...
    return base64.b64encode(
        cipher_pub_obj.encrypt(plain_text.encode())).decode()
...
if __name__ == "__main__":
    ...
    # res = pre_create(order_id="test9391", amount=100, tax=10, job_cd="CAPTURE")
    # token = "89430f5d3b57b8f3242b9bdcb55d4a724a635723faf8e92983e536bbeb75aae0"
    # res = execute_payment(
    #     access_id="e96c34d3dbe42d9917836be05c12d3dd",
    #     access_pass="8ca3b952ee1848f1ee72ca56844cc41a", order_id="test9391",
    #     card_no="", expire="", pin="", method="1", token=token)
    res = query_transaction_status(order_id="3454")
    # res = update_transaction(
    #     access_id="e96c34d3dbe42d9917836be05c12d3dd",
    #     access_pass="8ca3b952ee1848f1ee72ca56844cc41a", job_cd="VOID",
    #     amount=None, tax=None, method=1, pay_times=1)
    # res = change_transaction(
    #     access_id="e96c34d3dbe42d9917836be05c12d3dd",
    #     access_pass="8ca3b952ee1848f1ee72ca56844cc41a", job_cd="CAPTURE",
    #     amount="70", tax="")
