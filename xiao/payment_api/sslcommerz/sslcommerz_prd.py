...
store_id = "wwwperfeecomlive"
store_password = "5C86086CAA1DD33235"
...
transaction_query_api = "https://securepay.sslcommerz.com/validator/api/merchantTransIDvalidationAPI.php"
...
def query_transaction_by_session_id(session_key):
    args = {
...
if __name__ == "__main__":
    ...
    res = query_transaction_by_transaction_id(
        tran_id="aedb56a6fcf311ecad330255ac100102")
    # res = query_transaction_by_session_id(
    #     session_key="5394AC34688CBD76D105C0AC58942B84")
    print(res)
