...
APP_ID = "kp9b2f49b368004412a4e41908a06970"
APP_KEY = "deff959c2fc92aa77031eded4acbb89c"
MERCHANT_CODE = "20210823"
USER_NAME = "'09958273828"
"PWAAPP, PAY_BY_QRCODE,APPH5,MICROPAY,QRCODE_H5"
...
QUERY_REFUND_API = "http://api.kbzpay.com/payment/gateway/uat/queryrefund"
...
if __name__ == "__main__":
    # res = pre_create(
    #     merch_order_id="209911", total_amount="100", trans_currency="MMK",
    #     trade_type=QR_TRADE_TYPE, title=None, timeout_express=None,
    #     callback_info="34", operator_id=None, store_id=None, terminal_id=None,
    #     business_param=None)
    """
    res = verify_signature({
		...
		'code': '0',
		'msg': 'success',
		'merch_order_id': '102542',
		'merch_code': '20210823',
		'trans_order_id': '3103C713325688000155',
		'refund_status': 'REFUND_SUCCESS',
		# 'remain_refund_amount': '2102.78',
		'refund_order_id': '3003C714050688000155',
		'refund_amount': '1',
		'refund_currency': 'MMK',
		'refund_time': '1638862507',
		'nonce_str': 'GLNT4V8TVA47GQYSJOX9S8ZTRK2HQFRO',
		'sign_type': 'SHA256',
		'sign': '5E4B0DF05D5DF6617FAF7CABB661ACAE63B32C454A7F3CB2DF1AE585A5354163'
	})
    print(res)
    """
    ...
    res = query_order(
        merch_order_id="102662", mm_order_id=None,
        refund_request_no=4748)  # "86844"  "01002091070008232787" "483"
    # res = query_refund(merch_order_id="102542")
    # res = close_order("209911")
    # res = refund_order(
