...
public_key = "FLWPUBK-8aa06c7ab99ad8279a380fa3348d22af-X"
secret_key = "FLWSECK-e1911f0ea8147fce5eeb9f65286a5271-X"
encryption_key = "e1911f0ea814bcc4338118f6"
hash_secret = "uonmify31415926mall"

webhook_url = "https://uomnify.perfee.com/api/payment/flutterwave/webhook"
callback_url = "https://uomnify.perfee.com/api/payment/flutterwave/callback"
...
def verify_by_reference(tx_ref):
    ...
    result = requests.get(
        url=verify_by_reference_api, data=data, headers=headers,
        timeout=30)
    if str(result.status_code).startswith("5"):
        raise Exception("Request method not recognised or implemented.")
    response = result.json()
...
if __name__ == "__main__":
    ...
    #     tx_ref="test111", amount="200", email="xiaoyongsheng@perfee.com",
    ...
    # res = verify_by_reference(tx_ref="test111")
