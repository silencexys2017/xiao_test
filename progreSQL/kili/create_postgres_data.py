...
def create_tables(cursor):
    ...
    # cursor.execute("""DROP TYPE IF EXISTS PAYMENT_TYPE;""")
    # payment_type = """
    #     CREATE TYPE PAYMENT_TYPE AS ENUM ('cod', 'online', 'pre')
    #     """
    # cursor.execute(payment_type)
    # cursor.execute("""DROP TYPE IF EXISTS ORDER_TYPE;""")
    # order_types = """
    ...
    # cursor.execute("""DROP TYPE IF EXISTS SALE_ORDER_STATUS;""")
    # sale_order_status = """
    ...
    fact_sales_table = """CREATE TABLE if not exists fact_sales (
    ...
    fact_sales_daily_detail = """CREATE TABLE if not exists fact_sales_daily_detail (
                    date_key INTEGER,
    ...
    dim_cat_5 = """CREATE TABLE if not exists dim_cat_5 (
    id INTEGER,
    name VARCHAR(256),
    cat_1_id INTEGER,
    cat_2_id INTEGER,
    ...
    cursor.execute(dim_cat_5)

    dim_cat_4 = """CREATE TABLE if not exists dim_cat_4 (
    id INTEGER,
    name VARCHAR(256),
    cat_1_id INTEGER,
    cat_2_id INTEGER,
    ...
    cursor.execute(dim_cat_4)

    dim_cat_3 = """CREATE TABLE if not exists dim_cat_3 (
    id INTEGER,
    name VARCHAR(256),
    cat_1_id INTEGER,
    cat_2_id INTEGER
    ...
    dim_cat_2 = """CREATE TABLE if not exists dim_cat_2 (
        id INTEGER,
        name VARCHAR(256),
        cat_1_id INTEGER
        );"""
    ...
    dim_cat_1 = """CREATE TABLE if not exists dim_cat_1 (
        id INTEGER,
        name VARCHAR(256)
        );"""
    ...
    dim_area = """CREATE TABLE if not exists dim_area (
    id INTEGER,
    name VARCHAR(128),
    province_id INTEGER,
    city_id INTEGER,
    ...
    dim_city = """CREATE TABLE if not exists dim_city (
    id INTEGER,
    name VARCHAR(128),
    province_id INTEGER,
    region_id INTEGER
    ...
    dim_province = """CREATE TABLE if not exists dim_province (
    id INTEGER,
    name VARCHAR(128),
    region_id INTEGER
    );"""
    ...
    dim_region = """CREATE TABLE if not exists dim_region (
    id INTEGER,
    name VARCHAR(128),
    code VARCHAR(28)
    );"""
    ...
    dim_warehouse = """CREATE TABLE if not exists dim_warehouse (
    id INTEGER,
    name VARCHAR(128),
    region_id INTEGER
    );"""
    ...
    dw_sale_order = """CREATE TABLE if not exists dw_sale_order (
    ...
    dim_seller = """CREATE TABLE if not exists dim_seller (
            id INTEGER,
            region_id INTEGER,
            name VARCHAR(128),
            phone VARCHAR(28)
    ...
    dim_store = """CREATE TABLE if not exists dim_store (
    ...
    fact_sales_daily_summary = """CREATE TABLE if not exists fact_sales_daily_summary (
                date_key INTEGER,
                store_id INTEGER,
    ...
    fact_sales_monthly_aggr = """CREATE TABLE if not exists fact_sales_monthly_aggr (
                    month_key INTEGER,
                    store_id INTEGER,
                    store_name VARCHAR(128),
                    cat_3_id INTEGER,
    ...
    dim_time_date = """CREATE TABLE if not exists dim_time_date (
    ...
    dim_time_week = """CREATE TABLE if not exists dim_time_week (
    ...
    dim_time_month = """CREATE TABLE if not exists dim_time_month (
    ...
    dim_time_qtr = """CREATE TABLE if not exists dim_time_qtr (
    ...
    dim_time_year = """CREATE TABLE if not exists dim_time_year (
    ...
    actual_user_and_contact = """CREATE TABLE if not exists actual_user_and_contact (
    ...
    enum_sales_target = """CREATE TABLE if not exists enum_sales_target (
        id serial NOT NULL,
    ...
    enum_sales_dimension = """CREATE TABLE if not exists enum_sales_dimension (
            id serial NOT NULL,
            subject_name VARCHAR(256),
...
def insert_warehouse_and_cat(cursor):
    ...
    """
    cursor.execute("DELETE FROM dim_cat_2")
    ...
    cursor.execute("DELETE FROM dim_cat_3")
    ...
    cursor.execute("DELETE FROM dim_cat_4")
    for it in goods_db.Category.find({"depth": 4}):
        print(it)
        cat = it["path"].split(":")
        cat_1 = int(cat[0])
        cat_2 = int(cat[1])
        ...
        cursor.execute(
            sql.SQL("insert into {} values (%s, %s, %s, %s, %s)").format(
                sql.Identifier('dim_cat_4')), [
                it["_id"], it["name"], cat_1, cat_2, cat_3])

    cursor.execute("DELETE FROM dim_cat_5")
    for it in goods_db.Category.find({"depth": 5}):
        print(it)
        cat = it["path"].split(":")
        cat_1 = int(cat[0])
        cat_2 = int(cat[1])
        ...
        cursor.execute(
            sql.SQL("insert into {} values (%s, %s, %s, %s, %s,%s)").format(
                sql.Identifier('dim_cat_5')), [
                it["_id"], it["name"], cat_1, cat_2, cat_3, cat_4])

    cursor.execute("DELETE FROM dim_cat_1")
...
def insert_enum_into_base(cursor):
    ...
    execute_values(cursor, """INSERT INTO enum_sales_dimension (
        ...
        ("sales_top", "dateTime", "Date Time", False, 5,
         ...
         None, None),
        ("sales_top", "category", "Category", False, 5,
         '{{1,"first level"},{2,"second level"},{3, "third level"},{4,"fourth level"},{5,"fifth level"}}',
         None, None),
        ...
        ("sales_normal", "dateTime", "Date Time", True, 5,
         '{{1,"year"},{2,"quarterly"},{3, "month"}, {4, "week"}, {5, "day"}}',
         "col", None),
        ("sales_normal", "category", "Category", True, 5,
         '{{1,"first level"},{2,"second level"},{3, "third level"},{4,"fourth level"},{5,"fifth level"}}',
         "row", None),
